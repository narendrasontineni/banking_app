package com.narendra.spring.boot.banking.controller;
...
// http://localhost:8080/api/accounts/2
	@GetMapping("/{id}")
	public  ResponseEntity<AccountDto> getAccountbyId(@PathVariable Long id){  // @PathVariable -- to bind id to getAccountbyId(id)
